...
parser.add_argument("--sample_interval", type=int, default=73, help="interval between saving image samples")
...
dataloader = DataLoader(
    ImageDataset("datasets/training_hr_images/training_hr_images", hr_shape=hr_shape),
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        sys.stdout.write(
            "[Epoch %d/%d] [Batch %d/%d] [D loss: %f] [G loss: %f]\r"
